package com.xin.xindada.controller;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.xin.xindada.ai.AiManager;
import com.xin.xindada.annotation.AuthCheck;
import com.xin.xindada.common.BaseResponse;
import com.xin.xindada.common.DeleteRequest;
import com.xin.xindada.common.ErrorCode;
import com.xin.xindada.common.ResultUtils;
import com.xin.xindada.constant.UserConstant;
import com.xin.xindada.exception.BusinessException;
import com.xin.xindada.exception.ThrowUtils;
import com.xin.xindada.model.dto.question.*;
...
import com.xin.xindada.model.enums.AppTypeEnum;
import com.xin.xindada.model.vo.QuestionVO;
...
//        ThrowUtils.throwIf(size > 20, ErrorCode.PARAMS_ERROR);
    ...
    public BaseResponse<List<Question.QuestionContent>> aiGenerateQuestion(
        ...
        List<Question.QuestionContent> questionContentDTOList = JSONUtil.toList(json, Question.QuestionContent.class);
        return ResultUtils.success(questionContentDTOList);
    }

    @GetMapping("/ai_generate_sse")
    public SseEmitter aiGenerateQuestionSse(AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        // AI 生成
        Flowable<ModelData> flowable = aiManager.doFlowableRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userMessage, null);
        flowable.
                ...
                .flatMap(message -> {
                    List<Character> characterList = new ArrayList<>(message.length());
                ...
                .doOnNext(character -> {
                    ...
                    if (character == '}') {
                        ...
                        if (count.get() == 0) {
                            String data = msgBuilder.toString();
                            sseEmitter.send(JSONUtil.toJsonStr(data));
                ...
                .doOnComplete(()->{
                    sseEmitter.send(SseEmitter.event().name("close").data("Event Stream Closed"));
                    sseEmitter.complete();
                })
                .subscribe();
        return sseEmitter;
    ...
    public static void main(String[] args) {
        Test bean = JSONUtil.toBean(" {\"id\":2}", Test.class);
